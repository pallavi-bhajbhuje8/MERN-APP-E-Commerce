    ...
    return (
        <div className='container mx-auto p-4'>
            ...
            <div className='hidden lg:grid grid-cols-[200px,1fr]'>
                ...
                {/* rightside (product) */}
                <div className='px-4'>
                    <p className='font-medium text-slate-800 text-lg my-2'>Search Results 1 : {data.length}</p>
                    <div className='min-h-[calc(100vh-120px)] overflow-scroll max-h-[calc(100vh-120px)]'>
                        {
                            data.length !== 0 && (
