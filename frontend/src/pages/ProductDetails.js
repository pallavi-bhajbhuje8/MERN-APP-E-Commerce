...
const ProductDetails = () => {
    ...
    const fetchProductDetails = async () => {
        ...
        // console.log("Full API Response:", dataResponse)
            ...
            <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
                <div className='h-96 flex flex-col lg:flex-row-reverse gap-4 '>
                    ...
                    <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2 '>
                        <img src={activeImage} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={hadleZoomImage} onMouseLeave={handlLeaveImageZoom} />
                        {/* product zoom */}
                        {
                            zoomImage && (
                ...
                {/* product details */}
                {
                    loading ? (
                        <div className='grid gap-1 w-full'>
                            ...
                            <h2 className='text-2xl lg:text-4xl font-medium h-6 lg:h-8 w-full bg-slate-200 animate-pulse w-full'></h2>
                            <p className='capitalize text-slate-600 bg-slate-200 min-w-[100px] animate-pulse h-6 lg:h-8 w-full'></p>
                            ...
                            <div className='w-full'>
                                ...
                                <p className='h-10 lg:h-12 bg-slate-200 rounded animate-pulse h-10 w-full'></p>
                            </div>
                        </div>
                    ) : (
